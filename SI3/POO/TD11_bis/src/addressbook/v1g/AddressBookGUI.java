...
/**
 * Provide a GUI view of an AddressBook. Different panes provide access to the
 * data in the address book.
 * 
 * One to search the address book.
 * 
 * One to allow a set of contact details to be entered. The add button adds the
...
class AddressBookGUI extends JFrame {
     ...
     */
    AddressBookGUI(AddressBook book) {
        this.book = book;
    ...
    private Container setupSearchArea() {
        ...
        searchField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            /**
             * Search the address book and present the results unless the search
             * string is empty, in which case the results area is cleared.
             */
