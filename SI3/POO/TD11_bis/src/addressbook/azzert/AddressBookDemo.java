package addressbook.azzert;

import java.util.Arrays;

/**
 * A demo class for AddressBook. Some basic test methods are included. The
 * purpose of these is to see whether assertion errors are triggered for some of
 * the basic operations on an address book.
 * 
...
class AddressBookDemo {
    ...
    /**
     * Add for a second time an entry with duplicate name and phone details.
     * This should trigger an AssertionError.
     */
    void testForAdditionError() {
        setup();
    ...
    /**
     * @return The details of a contact who is originally in the address book.
     */
    ContactDetails getExistingContact() {
        return existingContact;
    }

    /**
     * @return The details of a further contact, not originally in the address
     *         book.
     */
    ContactDetails getFurtherContact() {
    ...
    private ContactDetails createRevisedDetails() {
        return new ContactDetails(existingContact.getName(),
                existingContact.getPhone(), existingContact.getAddress() + "X");
    }
}
