...
import td2.part3.EmptyQueueException;
...
public class GenealogyTree extends BinaryNode<String> {
	...
	public static void main(String[] args){
		...
		System.out.print("Ancestors at generation 4: ");
		for ( String s : g.ancestors(4) )
			System.out.print(s + " ");
		System.out.println();
		...
		System.out.print("Male ancestors at generation 4: ");
		for ( String s : g.maleAncestors(4) )
			System.out.print(s + " ");
		System.out.println();
