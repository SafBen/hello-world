...
class SuperBlock(Block):
	...
	def __init__(self, addr, size, error=False, tmp=True, **kwargs):
		super().__init__(addr, size, error=error, tmp=tmp, color=(160, 160, 160), *kwargs)
		self.label = None
...
class Header(Block):
	...
	def __init__(self, addr, error=False, tmp=False, **kwargs):
		super().__init__(addr - 16, 16, error=error, tmp=tmp, color=(224, 224, 224), *kwargs)
		self.label = "H"#eader"
...
if __name__ == '__main__':
	...
	parser.add_argument("--header", type=int, default=16, # 8
